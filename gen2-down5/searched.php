    ...
    <body>
        <div class = "container" id="container-top">
            ...
            <form style="border:none" class="search-top" action="search.php" id="submit">
                <input required id="in-search-top" type="text" name="stock" placeholder="Search stocks...">
            ...
            <div class="drop-top">
                ...
                <div id = "menu-drop-top" class="dropdown-content">
                    <a class="hov"  href="http://www.genzfinancial.com/gen2/cart.php">Cart</a>
            ...
            <div class="links-top">
                <ul>
                    <li><a class="hov" id="user-nav-link" href="http://www.genzfinancial.com/gen2/landing/login.php">User</a></li>
                    <li><a class="hov" id="stocks-nav-link" href="http://www.genzfinancial.com/gen2/stocks/stocks.php">Stocks</a></li>
                    <li><a id="info-nav-link" href="http://www.genzfinancial.com/extra">Info</a></li>
                    <li><a class="hov" id="lb-nav-link" href="http://www.genzfinancial.com/leaderboard">Ranks</a></li>
                    <li><a class="hov" id="play-nav-link" href="http://www.genzfinancial.com/gen2/index.php">Play</a></li>
                </ul>
            </div>
                    ...
                    <form class="modal-content border-t" action="http://www.genzfinancial.com/gen2/buy.php" method="post" id="buycontent">
                        ...
                        <div class="container operhead" id="modal-space">
                            ...
                            <div class="wrap-r">
                                ...
                                <div class="right-oper">
                                    <p class="p-f-l">Currently Owned: <span class="span-f-r"><?php echo $stockQuant;?></span></p>
                                    <p class="p-f-l">More: <span class="span-f-r more">0</span></p>
                                    <hr>
                                    <p class="p-f-l">Resulting: <span class="span-f-r moreres"><?php echo $stockQuant;?></span></p>
                                </div>
                    ...
                    <form class="modal-content border-t" action="http://www.genzfinancial.com/gen2/sell.php" method="post" id="buycontent">
                        ...
                        <div class="container operhead" id="modal-space">
                            ...
                            <div class = "wrap-r">
                                ...
                                <div class="right-oper">
                                    <p class="p-f-l">Purchase Value: <span class="span-f-r"><?php echo $stockQuant;?></span></p>
                                    <p class="p-f-l">Sell: <span class="span-f-r less">0</span></p>
                                    <hr>
                                    <p class="p-f-l">Net: <span class="span-f-r lessres"><?php echo $stockQuant;?></span></p>
                                </div>
                                <div class="right-oper">
                                    <p class="p-f-l">Currently Owned: <span class="span-f-r"><?php echo $stockQuant;?></span></p>
                                    <p class="p-f-l">Less: <span class="span-f-r less">0</span></p>
