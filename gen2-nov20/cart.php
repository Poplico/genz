...
toggle between hiding and showing the dropdown content */
    ...
    <body>
        <div class = "container" id="container-top">
            ...
            <form style="border:none" class="search-top" action="http://www.genzfinancial.com/gen2/search.php">
        ...
        <div class = "container-body">
            <div class ="upper-body">
                ...
                <a id="clear-cart-btn" href="http://www.genzfinancial.com/gen2/clear_cart.php">
                    Clear
                </a>
            </div>
        </div>
