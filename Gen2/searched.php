...
<html>
    <head>
        ...
        <link rel="stylesheet" href="http://www.genzfinancial.com/gen2/easyComplete/easy-autocomplete.themes.min.css"> 
        <link rel="stylesheet" href="http://www.genzfinancial.com/gen2/easyComplete/easy-autocomplete.min.css"> 
        <script src="http://www.genzfinancial.com/gen2/easyComplete/jquery.easy-autocomplete.min.js"></script> 
        <script>
            var options = {
                url: function(phrase) {
                    return "https://s.yimg.com/aq/autoc?query="+ phrase +"&region=US&lang=en-US&callback=YAHOO.util.UHScriptNodeDataSource.callbacks";
                },
                getValue: "symbol"
            };
            $("#in-search-top").easyAutocomplete(options);
        </script>
    </head>
    <body>
