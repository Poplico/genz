...
toggle between hiding and showing the dropdown content */
    ...
    <body>
        ...
        <div class = "container-body" id="searched-body" style="background-color:#1f2021" >
            <? if ($_SESSION['validSymbol'] == true): ?>
                        ...
                        <div class="container operhead" id="modal-space">
                            ...
                            <div class="wrap-r">
                                <div class="right-oper">
                                    ...
                                    <hr>
                                    <p class="p-f-l">Resulting: <span class="span-f-r costerres">$ ---.--</span></p>
                                </div>
                                <div class="right-oper">
                        ...
                        <div class="container operhead" id="modal-space">
                            ...
                            <div class = "wrap-r">
                                <div class="right-oper">
                                    ...
                                    <hr>
                                    <p class="p-f-l">Resulting: <span class="span-f-r gainerres">$ ---.--</span></p>
                                </div>
                                <div class="right-oper">
                                    <p class="p-f-l">Currently Owned: <span class="span-f-r"><?php echo $stockQuant;?></span></p>
            ...
            <div id="sidebar-left" class="middleRow">
                <div id="divFeedWind" class="marginRight10">
                    <!-- start feedwind code --> 
                ...
                <div id="divTradingView" class="marginRight10" style="width:100%">
                <!-- TradingView Widget BEGIN -->
                <script type="text/javascript">
